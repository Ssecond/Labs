    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            /*
                ...
                -------------------------------------------------------
                От 17.11.2023
                1) Возникновение каждой ошибки записать в лог журнал:
                в обычный текстовый документ, и в xml, и в json.
                Формат: [дата, название приложения (т.е. сборки), ошибка, трейслог];
                * Файл ошибки можно ложить, куда считаешь нужным.
                * Можно сделается через расширение класса Exception.
                * Можно добавмть «состояние системы» в начало лога.
                * Лог пишеться, когда возникают ошибки.
                * Логи разделять чем-нибудь уникальным, не пробелами.
            */
